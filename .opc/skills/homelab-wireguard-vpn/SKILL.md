...
description: WireGuard VPN server setup, peer configuration, key generation, split
  tunneling vs full tunnel routing, and remote access to a home network from mobile
  and laptop clients.
metadata:
  origin: community
  imported_from:
    ...
    original_name: homelab-wireguard-vpn
    imported_at: '2026-07-27T02:14:03.481199+00:00'
---
