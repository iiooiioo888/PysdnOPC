...
description: Expert guidance for developing with the tinystruct Java framework. Use
  ...
  HTTP/CLI dual-mode handling, the built-in HTTP server, the event system, JSON with
  Builder/Builders, database persistence with AbstractData, POJO generation, Server-Sent
  Events (SSE), file uploads, and outbound HTTP networking.
metadata:
  origin: ECC
  imported_from:
    source: ecc
    repo: https://github.com/affaan-m/ECC
    original_name: tinystruct-patterns
    imported_at: '2026-07-27T02:15:05.935414+00:00'
---
