...
description: Read a plan document, decompose it into steps, design a per-step agent
  ...
  plan and wants to drive it through orchestrate without composing chains by hand.
metadata:
  origin: ECC
  imported_from:
    source: ecc
    repo: https://github.com/affaan-m/ECC
    original_name: plan-orchestrate
    imported_at: '2026-07-27T02:14:05.407777+00:00'
---
