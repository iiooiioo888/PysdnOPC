...
description: Design composable recommendation, ranking, and feed pipelines using the
  ...
  any system that picks "the top K items for a (user, context)" — social feeds, content
  CMSs, RAG rerankers, task prioritizers, notification triage, search reranking, ad
  ranking.
metadata:
  origin: community
  imported_from:
    ...
    original_name: recsys-pipeline-architect
    imported_at: '2026-07-27T02:15:04.693854+00:00'
---
