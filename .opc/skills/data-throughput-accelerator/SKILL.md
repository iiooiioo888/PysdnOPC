...
description: Use when large data ingestion, backfill, export, ETL, warehouse loading,
  manifest catch-up, or table synchronization needs to become much faster while preserving
  data correctness.
license: MIT
metadata:
  origin: ECC
  imported_from:
    ...
    original_name: data-throughput-accelerator
    imported_at: '2026-07-27T02:14:02.072560+00:00'
