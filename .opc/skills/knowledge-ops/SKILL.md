...
description: Knowledge base management, ingestion, sync, and retrieval across multiple
  storage layers (local files, MCP memory, vector stores, Git repos). Use when the
  user wants to save, organize, sync, deduplicate, or search across their knowledge
  systems.
metadata:
  origin: ECC
  imported_from:
    ...
    original_name: knowledge-ops
    imported_at: '2026-07-27T02:14:03.841811+00:00'
---
