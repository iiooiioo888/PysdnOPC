...
description: Use when the user asks for repeated rollouts, marked decision processes,
  high-dimensional search, stochastic optimization, local-optima exploration, ensemble
  comparison, or recursive reasoning with a visible evidence trail.
license: MIT
metadata:
  origin: ECC
  imported_from:
    ...
    original_name: recursive-decision-ledger
    imported_at: '2026-07-27T02:15:04.708850+00:00'
