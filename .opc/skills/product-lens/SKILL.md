...
description: Use this skill to validate the "why" before building, run product diagnostics,
  and pressure-test product direction before the request becomes an implementation
  contract.
metadata:
  origin: ECC
  imported_from:
    ...
    original_name: product-lens
    imported_at: '2026-07-27T02:15:04.426853+00:00'
---
