...
description: Use for latency-sensitive systems such as realtime dashboards, market
  data, streaming agents, execution gateways, queues, caches, or HFT-like infrastructure
  where freshness and p95 latency matter.
license: MIT
metadata:
  origin: ECC
  imported_from:
    ...
    original_name: latency-critical-systems
    imported_at: '2026-07-27T02:14:04.017549+00:00'
