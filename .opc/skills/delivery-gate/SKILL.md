---
name: delivery-gate
description: Stop hook that blocks Claude from finishing until quality checks pass.
  Detects rationalization patterns (surface text heuristics), stale learning logs
  (filesystem mtime), and low disk space. Complements self-audit by mechanically enforcing
...
metadata:
  ...
  imported_from:
    ...
    original_name: delivery-gate
    imported_at: '2026-07-27T02:14:02.249568+00:00'
