...
description: Generates Angular code and provides architectural guidance. Trigger when
  ...
  (signals, linkedSignal, resource), forms, dependency injection, routing, SSR, accessibility
...
metadata:
  ...
  imported_from:
    ...
    original_name: angular-developer
    imported_at: '2026-07-27T02:14:00.362099+00:00'
---
