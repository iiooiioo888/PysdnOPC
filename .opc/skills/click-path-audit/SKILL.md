...
description: 'Trace every user-facing button/touchpoint through its full state change
  ...
  debugging found no bugs but users report broken buttons, or after any major refactor
  touching shared state stores.'
metadata:
  origin: community
  imported_from:
    source: ecc
    repo: https://github.com/affaan-m/ECC
    original_name: click-path-audit
    imported_at: '2026-07-27T02:14:01.620537+00:00'
---
