...
description: Diagnose interface errors, drops, CRCs, duplex mismatches, flapping,
  speed negotiation issues, and counter trends on routers, switches, and Linux hosts.
metadata:
  origin: community
  imported_from:
    source: ecc
    repo: https://github.com/affaan-m/ECC
    original_name: network-interface-health
    imported_at: '2026-07-27T02:14:04.499267+00:00'
---
