...
description: Multi-agent orchestration using dmux (tmux pane manager for AI agents).
  ...
  harnesses. Use when running multiple agent sessions in parallel or coordinating
...
metadata:
  ...
  imported_from:
    ...
    original_name: dmux-workflows
    imported_at: '2026-07-27T02:14:02.437768+00:00'
---
