...
description: Prisma ORM patterns for TypeScript backends — schema design, query optimization,
  ...
  records, $transaction timeouts, migrate dev resetting the DB, @updatedAt skipped
  on bulk writes, and serverless connection exhaustion.
metadata:
  origin: ECC
  imported_from:
    source: ecc
    repo: https://github.com/affaan-m/ECC
    original_name: prisma-patterns
    imported_at: '2026-07-27T02:14:05.496098+00:00'
---
