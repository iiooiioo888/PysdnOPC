...
class CliBoardApp(App[None]):
    ...
    BINDINGS = [
        ...
        Binding("tab", "focus_next_pane", t("tui.action.next_pane"), priority=True),
        Binding("shift+tab", "focus_prev_pane", t("tui.action.prev_pane"), show=False, priority=True),
        Binding("enter", "activate_selection", t("tui.action.open")),
        Binding("space", "toggle_density", t("tui.action.density")),
        Binding("1", "view_kanban", t("tui.view.kanban")),
        Binding("2", "view_list", t("tui.view.list")),
        Binding("3", "view_focus", t("tui.view.focus")),
        Binding("4", "view_pipeline", t("tui.view.pipeline")),
        Binding("5", "view_org", t("tui.view.org")),
        Binding("ctrl+k", "open_palette", t("tui.action.palette"), priority=True),
        Binding(":", "open_palette", t("tui.action.palette"), show=False, priority=True),
        Binding("n", "new_task", t("tui.action.new")),
        Binding("g", "run_selected", t("tui.action.run")),
        Binding("s", "reply", t("tui.action.reply")),
        Binding("m", "move_task", t("tui.action.move")),
        Binding("a", "approve_selected", t("tui.action.approve")),
        Binding("d", "deny_selected", t("tui.action.deny")),
        Binding("c", "mark_done", t("tui.action.done")),
        Binding("x", "cancel_task", t("tui.action.cancel")),
        Binding("t", "retry_selected", t("tui.action.retry")),
        Binding("e", "checkpoint_feedback", t("tui.action.feedback")),
        Binding("R", "rename_session", t("tui.action.rename"), show=False),
        Binding("D", "delete_session", t("tui.action.delete"), show=False),
        Binding("E", "switch_mode", t("tui.action.mode"), show=False),
        Binding("f", "toggle_done", t("tui.action.toggle_done")),
        Binding("/", "search", t("tui.action.search")),
        Binding("r", "refresh_board", t("tui.action.refresh")),
        Binding("?", "show_help", t("tui.action.help")),
        Binding("q", "quit_board", t("tui.action.quit")),
        Binding("ctrl+q", "quit_board", t("tui.action.return"), show=False, priority=True),
    ]
    ...
    async def on_mount(self) -> None:
        ...
        if not self.facade or not self.repository or not self.actions or not self.event_bridge:
            self.status_widget.set_message(t("tui.msg.standalone"))
            self._refresh_all_widgets()
            return
        self.status_widget.set_message(t("tui.msg.initializing"))
    ...
    def _require_actions(self) -> BoardActions | None:
        if self.readonly:
            self.status_widget.set_message(t("tui.msg.readonly"))
            return None
        if self.actions is None:
            self.status_widget.set_message(t("tui.msg.actions_unavailable"))
            return None
        return self.actions
    ...
    def _readonly_guard(self) -> bool:
        if not self.readonly:
            return False
        self.status_widget.set_message(t("tui.msg.readonly_quit"))
        return True
    ...
    def action_move_left(self) -> None:
        if self.state.pane_focus == "context":
            ...
            self.status_widget.set_message(t("tui.msg.context_tab", tab=self.state.context_tab))
            self._refresh_all_widgets()
            return
        if self.state.pane_focus == "session-rail":
            self.state.set_pane_focus("main")
            self.status_widget.set_message(t("tui.msg.focused_main"))
            self._refresh_all_widgets()
            return
        ...
        self.status_widget.set_message(t("tui.msg.switched_view", view=self.state.view_mode))
        self._refresh_all_widgets()
    ...
    def action_focus_next_pane(self) -> None:
        ...
        self.status_widget.set_message(t("tui.msg.focused_pane", pane=focus))
        self._refresh_all_widgets()
    ...
    def action_activate_selection(self) -> None:
        if self.state.pane_focus == "session-rail":
            ...
            self.state.set_pane_focus("main")
            self.status_widget.set_message(t("tui.msg.opened_focus"))
            self._refresh_all_widgets()
            return
        if self.state.pane_focus == "main":
            if self.state.view_mode != "focus":
                ...
                self.status_widget.set_message(t("tui.msg.focused_context"))
            self._refresh_all_widgets()
            return
        self.state.cycle_context_tab(1)
        self.status_widget.set_message(t("tui.msg.context_tab", tab=self.state.context_tab))
    ...
    def action_toggle_density(self) -> None:
        ...
        self.status_widget.set_message(t("tui.msg.density", density=density))
        self._refresh_all_widgets()

    def action_view_kanban(self) -> None:
        self.state.set_view_mode("kanban")
        self.status_widget.set_message(t("tui.msg.kanban_enabled"))
        self._refresh_all_widgets()

    def action_view_list(self) -> None:
        self.state.set_view_mode("list")
        self.status_widget.set_message(t("tui.msg.list_enabled"))
        self._refresh_all_widgets()

    def action_view_focus(self) -> None:
        self.state.set_view_mode("focus")
        self.status_widget.set_message(t("tui.msg.focus_enabled"))
        self._refresh_all_widgets()

    def action_view_pipeline(self) -> None:
        self.state.set_view_mode("pipeline")
        self.status_widget.set_message(t("tui.msg.pipeline_enabled"))
    ...
    def action_view_org(self) -> None:
        ...
        self.status_widget.set_message(t("tui.msg.org_enabled"))
    ...
    async def _action_new_task(self) -> None:
        result = await self.push_screen_wait(
            PromptScreen(
                title=t("tui.prompt.create_task"),
                fields=[
                    PromptField("title", t("tui.field.title"), placeholder="Short task title"),
                    PromptField("description", t("tui.field.description"), placeholder="Optional description"),
                    PromptField("message", t("tui.field.message"), placeholder="Optional first prompt to run immediately"),
                ],
                help_text=t("tui.help.create_task"),
                confirm_label=t("tui.confirm.create"),
            )
        )
        if not result:
            return
        ...
        await self._launch_action(
            ...
            success_message=t("tui.msg.task_created"),
        )

    async def action_run_selected(self) -> None:
        task = self.state.selected_task()
        if task is None:
            self.status_widget.set_message(t("tui.msg.no_task_selected"))
            return
        actions = self._require_actions()
        if actions is None:
            return
        self._launch_background(
            ...
            success_message=t("tui.msg.triggered", title=task.title),
        )
    ...
    async def _action_reply(self) -> None:
        ...
        result = await self.push_screen_wait(
            PromptScreen(
                title=t("tui.prompt.reply_to", title=task.title),
                fields=[PromptField("message", t("tui.field.message"), placeholder="Continue the session")],
                confirm_label=t("tui.confirm.send"),
            )
        )
        ...
        self._launch_background(
            ...
            success_message=t("tui.msg.reply_sent", title=task.title),
        )
    ...
    async def _action_move_task(self) -> None:
        ...
        result = await self.push_screen_wait(
            PromptScreen(
                title=t("tui.prompt.move_task", title=task.title),
                fields=[PromptField("column", t("tui.field.column"), value=task.column_id, placeholder="todo / in-progress / done")],
                confirm_label=t("tui.confirm.move"),
            )
        )
        if not result:
            return
        ...
        self._launch_background(
            ...
            success_message=t("tui.msg.moved", title=task.title),
        )
    ...
    def action_approve_selected(self) -> None:
        ...
        self._launch_background(
            ...
            success_message=t("tui.msg.approved", title=task.title),
        )
    ...
    def action_deny_selected(self) -> None:
        ...
        self._launch_background(
            ...
            success_message=t("tui.msg.denied", title=task.title),
        )
    ...
    def action_mark_done(self) -> None:
        ...
        self._launch_background(
            ...
            success_message=t("tui.msg.marked_done", title=task.title),
        )
    ...
    def action_cancel_task(self) -> None:
        ...
        self._launch_background(
            ...
            success_message=t("tui.msg.cancelled", title=task.title),
        )
    ...
    def action_retry_selected(self) -> None:
        ...
        self._launch_background(
            ...
            success_message=t("tui.msg.reran", title=task.title),
        )
    ...
    async def _action_switch_mode(self) -> None:
        result = await self.push_screen_wait(
            PromptScreen(
                title=t("tui.prompt.switch_mode"),
                fields=[
                    PromptField("mode", t("tui.field.mode"), value=self.exec_mode, placeholder="task / company / custom"),
                    PromptField("profile", t("tui.field.profile"), value=self.company_profile, placeholder="corporate / custom"),
                ],
                help_text=t("tui.help.switch_mode"),
                confirm_label=t("tui.confirm.apply"),
            )
        )
        if not result:
            return
        ...
        self.status_widget.set_message(t("tui.msg.mode_set", mode=self.exec_mode, profile=self.company_profile))
        self._refresh_all_widgets()
    ...
    async def _action_checkpoint_feedback(self) -> None:
        ...
        if not task.pending_checkpoint:
            self.status_widget.set_message(t("tui.msg.no_checkpoint"))
            return
        result = await self.push_screen_wait(
            PromptScreen(
                title=t("tui.prompt.checkpoint_feedback", label=task.pending_checkpoint.short_label),
                fields=[
                    PromptField("feedback", t("tui.field.feedback"), placeholder="Provide guidance or constraints...", multiline=True),
                    PromptField("action", t("tui.field.action"), value="approve", placeholder="approve / deny"),
                ],
                help_text=t("tui.help.feedback"),
                confirm_label=t("tui.confirm.send"),
            )
        )
        if not result:
    ...
    async def _action_rename_session(self) -> None:
        ...
        result = await self.push_screen_wait(
            PromptScreen(
                title=t("tui.prompt.rename_session"),
                fields=[PromptField("title", t("tui.field.new_title"), value=task.title)],
                confirm_label=t("tui.confirm.rename"),
            )
        )
        if not result:
            return
        ...
        if not new_title:
            self.status_widget.set_message(t("tui.msg.title_empty"))
            return
        actions = self._require_actions()
        if actions is None:
            return
        try:
            engine = await self.facade.ensure_ready()
            if engine.store:
                task_obj = await engine.store.get_task(task.task_id)
                if task_obj:
                    task_obj.title = new_title
                    await engine.store.save_task(task_obj)
                    await self._refresh_snapshot(reason="rename", silent=True)
                    self.status_widget.set_message(t("tui.msg.renamed", title=new_title))
        except Exception as exc:
            self.status_widget.set_message(t("tui.msg.rename_failed", error=exc))
    ...
    async def _action_delete_session(self) -> None:
        ...
        result = await self.push_screen_wait(
            PromptScreen(
                title=t("tui.prompt.delete_session", title=task.title),
                fields=[PromptField("confirm", t("tui.field.confirm"), placeholder="yes")],
                help_text=t("tui.help.delete_session"),
                confirm_label=t("tui.confirm.delete"),
            )
        )
        if not result or result.get("confirm", "").strip().lower() != "yes":
            self.status_widget.set_message(t("tui.msg.cancelled_op"))
            return
        try:
            engine = await self.facade.ensure_ready()
            if engine.store:
            ...
            self.status_widget.set_message(t("tui.msg.deleted", title=task.title))
        except Exception as exc:
            self.status_widget.set_message(t("tui.msg.delete_failed", error=exc))
    ...
    async def _action_purge_cancelled(self) -> None:
        ...
        if not engine or not engine.store:
            self.status_widget.set_message(t("tui.msg.store_unavailable"))
            return
        ...
        if not purgeable:
            self.status_widget.set_message(t("tui.msg.no_purgeable"))
            return

        result = await self.push_screen_wait(
            PromptScreen(
                title=t("tui.prompt.purge_tasks", count=len(purgeable)),
                fields=[PromptField("confirm", t("tui.field.confirm"), placeholder="yes")],
                help_text=t("tui.help.purge_tasks", count=len(purgeable)),
                confirm_label=t("tui.confirm.purge"),
            )
        )
        if not result or result.get("confirm", "").strip().lower() != "yes":
            self.status_widget.set_message(t("tui.msg.cancelled_op"))
        ...
        self.status_widget.set_message(t("tui.msg.purged", count=deleted))
    ...
    async def _action_switch_project(self) -> None:
        ...
        result = await self.push_screen_wait(
            PromptScreen(
                title=t("tui.prompt.switch_project"),
                fields=[
                    PromptField("project", t("tui.field.project"), value=self.project_id or "default",
                                placeholder=hint),
                ],
                help_text=f"Available: {hint}",
                confirm_label=t("tui.confirm.switch"),
            )
        )
        if not result:
            return
        ...
        if not new_id or new_id == (self.project_id or "default"):
            self.status_widget.set_message(t("tui.msg.project_unchanged"))
            return

        # Shutdown current engine and reinitialize
        self.status_widget.set_message(t("tui.msg.switching_project", project=new_id))
        ...
        self.reconcile_loop = ReconcileLoop(self.refresh_interval, self._refresh_from_reconcile)
        self.run_worker(self.reconcile_loop.run(), group="reconcile", exclusive=True)
        self.status_widget.set_message(t("tui.msg.switched_project", project=new_id))
    ...
    async def _action_project_create(self) -> None:
        result = await self.push_screen_wait(
            PromptScreen(
                title=t("tui.prompt.create_project"),
                fields=[PromptField("project", t("tui.field.project"), placeholder="letters, numbers, hyphens, underscores")],
                confirm_label=t("tui.confirm.create"),
            )
        )
        if not result:
        ...
        if not project_id:
            self.status_widget.set_message(t("tui.msg.project_id_empty"))
            return
        try:
            await self._run_office_service(lambda svc: svc.project.create(project_id, active_project_id=self.project_id or "default"))
            self.status_widget.set_message(t("tui.msg.project_created", project=project_id))
        except Exception as exc:
            self.status_widget.set_message(t("tui.msg.project_create_failed", error=exc))
    ...
    async def _action_project_delete(self) -> None:
        ...
        try:
            ...
            self.status_widget.set_message(t("tui.msg.project_deleted", project=project_id))
            ...
            self.status_widget.set_message(t("tui.msg.project_delete_failed", error=exc))
    ...
    async def _action_session_config(self) -> None:
        task = self.state.selected_task()
        if task is None:
            self.status_widget.set_message(t("tui.msg.no_session_selected"))
            return
        ...
        try:
            ...
            self.status_widget.set_message(t("tui.msg.session_config_updated"))
        except Exception as exc:
            self.status_widget.set_message(t("tui.msg.session_config_failed", error=exc))
    ...
    async def _action_org_add_role(self) -> None:
        ...
        try:
            ...
            self.status_widget.set_message(t("tui.msg.role_added"))
        except Exception as exc:
            self.status_widget.set_message(t("tui.msg.add_role_failed", error=exc))
    ...
    async def _action_talent_scan(self) -> None:
        try:
            ...
            self.status_widget.set_message(t("tui.msg.talent_scan_found", count=count))
        except Exception as exc:
            self.status_widget.set_message(t("tui.msg.talent_scan_failed", error=exc))
    ...
    async def _action_market_browse(self) -> None:
        try:
            ...
            self.status_widget.set_message(t("tui.msg.market_presets", count=count))
        except Exception as exc:
            self.status_widget.set_message(t("tui.msg.market_browse_failed", error=exc))
    ...
    async def _action_agent_list(self) -> None:
        try:
            ...
            self.status_widget.set_message(t("tui.msg.agents_count", count=count))
        except Exception as exc:
            self.status_widget.set_message(t("tui.msg.agent_list_failed", error=exc))
    ...
    async def _action_role_logs(self) -> None:
        ...
        if not role_id:
            self.status_widget.set_message(t("tui.msg.no_role_selected"))
            return
        try:
            ...
            self.status_widget.set_message(t("tui.msg.role_logs_count", role=role_id, count=count))
        except Exception as exc:
            self.status_widget.set_message(t("tui.msg.role_logs_failed", error=exc))

    def action_toggle_done(self) -> None:
        showing = self.state.toggle_show_done()
        self.status_widget.set_message(t("tui.msg.done_visible") if showing else t("tui.msg.done_hidden"))
    ...
    async def _action_search(self) -> None:
        ...
        self.status_widget.set_message(t("tui.msg.search_updated"))
        self._selection_changed(load_detail=True)
    ...
    async def _refresh_snapshot(self, *, reason: str, silent: bool = False) -> None:
        ...
        async with self._refresh_lock:
            ...
            if not silent:
                self.status_widget.set_message(t("tui.msg.board_refreshed", reason=reason))
    ...
    async def _apply_initial_inspector_target(self) -> None:
        ...
        if self.attach:
            ...
            self.status_widget.set_message(t("tui.msg.attached_inspector", mode=mode))
        if view == "pipeline":
    ...
    async def _launch_action(self, coro: Any, *, success_message: str) -> None:
        try:
            ...
            self.status_widget.set_message(t("tui.msg.action_failed", error=exc))

    def _launch_background(self, coro: Any, *, success_message: str) -> None:
        self.status_widget.set_message(t("tui.msg.working"))
    ...
    async def _dispatch_palette_command(self, command_id: str) -> None:
        ...
        if action is None:
            self.status_widget.set_message(t("tui.msg.unknown_command", command=command_id))
            return
        result = action()
